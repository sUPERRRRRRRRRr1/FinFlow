...
export type CategoryId =
  ...
  | 'health' // สุขภาพ
  | 'education' // การศึกษา
  | 'transfer' // โอน/ถอนเงินสด ออกไปยังผู้อื่น/กดเงินสด (นับเป็นเงินออกจริง)
  | 'own_transfer' // โอนเข้าบัญชีตัวเอง — ย้ายเงินระหว่างกระเป๋าของเราเอง (เป็นกลาง ไม่ใช่รายรับ/รายจ่าย)
  | 'savings' // ออม/ลงทุน
  | 'other'; // อื่นๆ
...
export interface Transaction {
  ...
  /** บัญชีปลายทางของการโอนเข้าบัญชีตัวเอง เมื่อตรวจจากเลขบัญชีได้แต่ยังไม่มีคู่ (statement มาฝั่งเดียว) — ใช้วาด Sankey กระเป๋า→กระเป๋า */
  transferTo?: string;
